...
class EventForm(forms.ModelForm):
    ...
    start_date = forms.DateTimeField(
        ...
        error_messages={"invalid": ("Invalid Startdate")},
        required=True,
    )
    ...
    parent_type = forms.ChoiceField(
        choices=parent_typeChoices,
        error_messages={"invalid": ("Invalid parent_type selected.")},
        required=False,
    )
...
class TaskEventForm(EventForm):
    ...
    priority = forms.ChoiceField(
        ...
        error_messages={"invalid": ("Invalid Priority selected.")},
        required=True,
    )  # only tasks
...
class CallEventForm(EventForm):
    ...
    direction = forms.ChoiceField(
        ...
        error_messages={"invalid": ("Invalid Direction selected.")},
        required=True,
    )
    duration = forms.ChoiceField(
        ...
        error_messages={"invalid": ("Invalid Duration selected.")},
        required=True,
    )  # not for tasks
